...
DLL_API DomainBitElement domain_bit_create_constant(bool value);
DLL_API DomainBitElement domain_bit_create_top(bool isSymbolic);
DLL_API DomainMultiBitElement domain_bit_create_cast_multibit(
      DomainBitElement bitDomain, int sizeInBits, DomainEvaluationEnvironment* env);
DLL_API bool domain_bit_unary_apply_assign(DomainBitElement* element,
      DomainBitUnaryOperation operation, DomainEvaluationEnvironment* env);
DLL_API DomainBitElement domain_bit_create_unary_apply(DomainBitElement element,
      DomainBitUnaryOperation operation, DomainEvaluationEnvironment* env);
DLL_API bool domain_bit_binary_apply_assign(DomainBitElement* element,
      DomainBitBinaryOperation operation, DomainBitElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainBitElement domain_bit_create_binary_apply(DomainBitElement element,
      DomainBitBinaryOperation operation, DomainBitElement source,
      DomainEvaluationEnvironment* env);
DLL_API ZeroResult domain_bit_binary_compare(DomainBitElement element,
      DomainBitCompareOperation operation, DomainBitElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainBitElement domain_bit_binary_compare_domain(DomainBitElement element,
      DomainBitCompareOperation operation, DomainBitElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainBitElement domain_bit_guard_assign(DomainBitElement* condition,
      DomainBitElement* first, DomainBitElement* second,
      DomainEvaluationEnvironment* env);
DLL_API ZeroResult domain_bit_query_boolean(DomainBitElement element);
DLL_API bool domain_bit_cast_multibit_constraint(DomainMultiBitElement result,
      int sizeInBits, DomainBitElement* element, DomainEvaluationEnvironment* env);
DLL_API bool domain_bit_unary_constraint(DomainBitElement result,
      DomainBitUnaryOperation operation, DomainBitElement* element, DomainEvaluationEnvironment* env);
DLL_API bool domain_bit_binary_constraint(DomainBitElement result,
      DomainBitBinaryOperation operation, DomainBitElement* first, DomainBitElement* second,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_bit_compare_constraint(DomainBitElement result,
      DomainBitCompareOperation operation, DomainBitElement* first, DomainBitElement* second,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_bit_is_constant_value(DomainBitElement domain, bool* value);

DLL_API DomainMultiBitElement domain_multibit_create_constant(DomainIntegerConstant value);
DLL_API DomainMultiBitElement domain_multibit_create_top(int sizeInBits, bool isSymbolic);
DLL_API DomainMultiBitElement domain_multibit_create_interval_and_absorb(
      DomainMultiBitElement* min, DomainMultiBitElement* max, bool isSigned, bool isSymbolic);
DLL_API DomainBitElement domain_multibit_create_cast_bit(DomainMultiBitElement multibitDomain,
      DomainEvaluationEnvironment* env);
DLL_API DomainBitElement domain_multibit_create_cast_shift_bit(DomainMultiBitElement multibitDomain,
      int shift, DomainEvaluationEnvironment* env);
DLL_API DomainMultiBitElement domain_multibit_create_cast_multibit(DomainMultiBitElement multibitSource,
      int destinationSizeInBits, bool isSigned, DomainEvaluationEnvironment* env);
DLL_API DomainMultiFloatElement domain_multibit_create_cast_multifloat(
      DomainMultiBitElement multibitDomain, int sizeInBits, bool isSigned,
      DomainEvaluationEnvironment* env);
DLL_API DomainMultiFloatElement domain_multibit_create_cast_multifloat_ptr(
      DomainMultiBitElement multibitDomain, int sizeInBits, bool isSigned,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_unary_apply_assign(DomainMultiBitElement* element,
      DomainMultiBitUnaryOperation operation, DomainEvaluationEnvironment* env);
DLL_API DomainMultiBitElement domain_multibit_create_unary_apply(DomainMultiBitElement element,
      DomainMultiBitUnaryOperation operation, DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_extend_apply_assign(DomainMultiBitElement* element,
      DomainMultiBitExtendOperation operation, DomainEvaluationEnvironment* env);
DLL_API DomainMultiBitElement domain_multibit_create_extend_apply(DomainMultiBitElement element,
      DomainMultiBitExtendOperation operation, DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_reduce_apply_assign(DomainMultiBitElement* element,
      DomainMultiBitReduceOperation operation, DomainEvaluationEnvironment* env);
DLL_API DomainMultiBitElement domain_multibit_create_reduce_apply(DomainMultiBitElement element,
      DomainMultiBitReduceOperation operation, DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_bitset_apply_assign(DomainMultiBitElement* element,
      DomainMultiBitSetOperation operation, DomainMultiBitElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainMultiBitElement domain_multibit_create_bitset_apply(DomainMultiBitElement element,
      DomainMultiBitSetOperation operation, DomainMultiBitElement source,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_binary_apply_assign(DomainMultiBitElement* element,
      DomainMultiBitBinaryOperation operation, DomainMultiBitElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainMultiBitElement domain_multibit_create_binary_apply(DomainMultiBitElement element,
      DomainMultiBitBinaryOperation operation, DomainMultiBitElement source,
      DomainEvaluationEnvironment* env);
DLL_API ZeroResult domain_multibit_binary_compare(DomainMultiBitElement element,
      DomainMultiBitCompareOperation operation, DomainMultiBitElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainBitElement domain_multibit_binary_compare_domain(DomainMultiBitElement element,
      DomainMultiBitCompareOperation operation, DomainMultiBitElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainMultiBitElement domain_multibit_guard_assign(DomainBitElement* condition,
      DomainMultiBitElement* first, DomainMultiBitElement* second,
      DomainEvaluationEnvironment* env);
DLL_API ZeroResult domain_multibit_query_boolean(DomainMultiBitElement element);
DLL_API bool domain_multibit_cast_bit_constraint(DomainBitElement result,
      DomainMultiBitElement* element, DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_cast_shift_bit_constraint(DomainBitElement result,
      int shift, DomainMultiBitElement* element, DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_cast_multifloat_constraint(DomainMultiFloatElement result,
      int sizeInBits, bool isSigned, DomainMultiBitElement* element, DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_cast_multifloat_ptr_constraint(DomainMultiFloatElement result,
      int sizeInBits, bool isSigned, DomainMultiBitElement* element, DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_unary_constraint(DomainMultiBitElement result,
      DomainMultiBitUnaryOperation operation, DomainMultiBitElement* element,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_extend_constraint(DomainMultiBitElement result,
      DomainMultiBitExtendOperation operation, DomainMultiBitElement* element,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_reduce_constraint(DomainMultiBitElement result,
      DomainMultiBitReduceOperation operation, DomainMultiBitElement* element,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_bitset_constraint(DomainMultiBitElement result,
...
DLL_API bool domain_multibit_binary_constraint(DomainMultiBitElement result,
      DomainMultiBitBinaryOperation operation, DomainMultiBitElement* first,
      DomainMultiBitElement* second, DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_compare_constraint(DomainBitElement result,
      DomainMultiBitCompareOperation operation, DomainMultiBitElement* first,
      DomainMultiBitElement* second, DomainEvaluationEnvironment* env);
DLL_API bool domain_multibit_is_constant_value(DomainMultiBitElement domain,
      DomainIntegerConstant* value);

DLL_API DomainMultiFloatElement domain_multifloat_create_constant(
      DomainFloatingPointConstant value);
DLL_API DomainMultiFloatElement domain_multifloat_create_top(int sizeInBits, bool isSymbolic);
DLL_API DomainMultiFloatElement domain_multifloat_create_interval_and_absorb(
      DomainMultiFloatElement* min, DomainMultiFloatElement* max, bool isSymbolic);
DLL_API DomainMultiBitElement domain_multifloat_create_cast_multibit(
      DomainMultiFloatElement multibitDomain, int sizeInBits,
      DomainEvaluationEnvironment* env);
DLL_API DomainMultiBitElement domain_multifloat_query_to_multibit(
      DomainMultiFloatElement multifloatDomain, DomainMultiFloatToIntOperation operation,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_cast_multifloat_assign(DomainMultiFloatElement* element,
      int size_in_bits, DomainEvaluationEnvironment* env);
DLL_API DomainMultiFloatElement domain_multifloat_cast_multifloat(
      DomainMultiFloatElement element, int size_in_bits,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_unary_apply_assign(DomainMultiFloatElement* element,
...
DLL_API DomainMultiFloatElement domain_multifloat_create_unary_apply(
      ...
      DomainEvaluationEnvironment* env);
DLL_API DomainBitElement domain_multifloat_flush_to_zero(DomainMultiFloatElement* element,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_binary_apply_assign(DomainMultiFloatElement* element,
      DomainMultiFloatBinaryOperation operation, DomainMultiFloatElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainMultiFloatElement domain_multifloat_create_binary_apply(
...
DLL_API ZeroResult domain_multifloat_binary_compare(DomainMultiFloatElement element,
      DomainMultiFloatCompareOperation operation, DomainMultiFloatElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainBitElement domain_multifloat_binary_compare_domain(DomainMultiFloatElement element,
      DomainMultiFloatCompareOperation operation, DomainMultiFloatElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainMultiBitElement domain_multifloat_binary_full_compare_domain(
      DomainMultiFloatElement element, DomainMultiFloatElement source,
      DomainEvaluationEnvironment* env);
DLL_API DomainMultiFloatElement domain_multifloat_guard_assign(DomainBitElement* condition,
      DomainMultiFloatElement* first, DomainMultiFloatElement* second,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_ternary_apply_assign(DomainMultiFloatElement* element,
...
DLL_API DomainBitElement domain_multifloat_ternary_query(DomainMultiFloatElement multifloatDomain,
...
DLL_API DomainMultiFloatElement domain_multifloat_create_ternary_apply(
      ...
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_cast_multibit_constraint(DomainMultiBitElement result,
      int sizeInBits, DomainMultiFloatElement* element, DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_query_to_multibit_constraint(DomainMultiBitElement result,
      DomainMultiFloatToIntOperation operation, DomainMultiFloatElement* element,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_cast_multifloat_constraint(DomainMultiFloatElement result,
      int size_in_bits, DomainMultiFloatElement* element, DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_unary_constraint(DomainMultiFloatElement result,
      DomainMultiFloatUnaryOperation operation, DomainMultiFloatElement* element,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_binary_constraint(DomainMultiFloatElement result,
      DomainMultiFloatBinaryOperation operation, DomainMultiFloatElement* first,
      DomainMultiFloatElement* second, DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_compare_constraint(DomainBitElement result,
      DomainMultiFloatCompareOperation operation, DomainMultiFloatElement* first,
      DomainMultiFloatElement* second, DomainEvaluationEnvironment* env);
DLL_API bool domain_multifloat_ternary_constraint(DomainMultiFloatElement result,
...
DLL_API char* domain_write(DomainElement domain, char* buffer, int buffer_size, int* length,
      void* writer, char* (*increase_buffer_size)(char* buffer, int old_length, int new_length, void* writer));
DLL_API bool domain_merge(DomainElement* element, DomainElement source,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_intersect(DomainElement* element, DomainElement source,
      DomainEvaluationEnvironment* env);
DLL_API bool domain_contain(DomainElement element, DomainElement source,
      DomainEvaluationEnvironment* env);
DLL_API int domain_compare(DomainElement element, DomainElement source);
